...
public class AdapterInfoGempa$InfoHolder_ViewBinding implements Unbinder {
  private AdapterInfoGempaDirasakan.InfoHolder target;

  @UiThread
  public AdapterInfoGempa$InfoHolder_ViewBinding(AdapterInfoGempaDirasakan.InfoHolder target, View source) {
    this.target = target;
